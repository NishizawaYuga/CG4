...
void Object3d::Initialize()
{
	...
	result = device->CreateCommittedResource(
		...
		nullptr,
		IID_PPV_ARGS(&coustBuffTransform));
}
...
void Object3d::Update()
{
	...
	result = coustBuffTransform->Map(0, nullptr, (void**)&constMap);
	if (SUCCEEDED(result)) {
		constMap->viewproj = matViewProjection;		//えらーぽいんと
		constMap->world = modelTransform * matWorld;
		constMap->cameraPos = cameraPos;
		coustBuffTransform->Unmap(0, nullptr);
	}
}
...
void Object3d::Draw(ID3D12GraphicsCommandList* cmdList)
{
	...
	cmdList->SetGraphicsRootConstantBufferView(0,
		coustBuffTransform->GetGPUVirtualAddress());
